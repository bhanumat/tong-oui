;(function () {
    ...
    angular
        ...
        .constant('MESSAGES', {
            ...
            'blacklist_warning':'บริษัท ซิกน่า ประกันภัย จำกัด (มหาชน) ขออภัยที่จะเรียนให้ท่านทราบว่าทางบริษัทฯ ไม่สามารถรับประกันภัยตามคำขอของท่านได้ เนื่องจากกฏเกณฑ์ของบริษัทฯ ({{msg}})',
            'overlap_warning':'ท่านมีประกันเดินทางในช่วงวัน/เวลาดังกล่าว กรุณาเลือกวันเดินทางใหม่ ({{msg}})',
        })
