;(function () {
    ...
    angular
        ...
        .constant('MESSAGES', {
            ...
            'confirm_passengers_change':'ยืนยัน การแก้ไขจำนวนผู้ขอประกัน'
        })
        .constant('PAYMENT_INFO', {
            ...
            'merchantId':'1203',
            'currCode':'764',
            'successUrl':'http://bhanumat.16b.com/#/insurance/thankyou',
            'failUrl':'http://bhanumat.16b.com/#/insurance/payment',
