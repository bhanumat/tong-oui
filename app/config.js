;(function () {
    ...
    angular
        ...
        .constant('MESSAGES', {
            ...
            'privilege_voluntary': 'เลือกเพิ่ม! จ่ายเพิ่มเพียงเล็กน้อย ได้ความคุ้มครองที่เหนือกว่า - คุ้มครองเที่ยวบินล่าช้า พลาดต่อเที่ยวบิน - กระเป๋าหรือทรัพย์สินเสียหาย- รวมไปถึงความรับผิดต่อบุคคลภายนอก'
        });
