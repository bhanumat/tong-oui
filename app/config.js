;(function () {
    ...
    angular
        ...
        .constant('PAYMENT_INFO', {
            ...
            //'failUrl':'http://www.bhanumat.16mb.com/#/insurance/payment',
            //'successUrl':'http://www.bhanumat.16mb.com/#/insurance/thankyou',
            //'cancelUrl':'http://www.bhanumat.16mb.com/#/insurance/payment',
            'successUrl': 'http://192.168.1.102:3000/#/insurance/thankyou',
            'failUrl': 'http://192.168.1.102:3000/#/insurance/payment',
            'cancelUrl': 'http://192.168.1.102:3000/#/insurance/payment',
            'payType': 'N',
            'lang': 'T',
            'remark': '-',
            'cards': {
